...
class Buku extends CI_Controller
{
    ...
    public function ubahBuku()
    {
        ...
        // Mengambil data buku dari model (menggunakan row_array() untuk mendapatkan array asosiatif)
        $data['buku'] = $this->ModelBuku->bukuWhere(['id' => $idBuku])->row_array();
        $kategori = $this->ModelBuku->joinKategoriBuku(['buku.id' => $idBuku])->result_array();
